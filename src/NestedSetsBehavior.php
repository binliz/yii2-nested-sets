...
class NestedSetsBehavior extends Behavior
{
        ...
        $condition = [
            ...
            [
                $this->rightAttribute => new Expression(
                    $this->owner->getDb()->quoteColumnName($this->leftAttribute) . '+ 1'
                )
            ],
        ];
    ...
    {
        return $this->owner->getAttribute($this->rightAttribute) - $this->owner->getAttribute(
                $this->leftAttribute
            ) === 1;
    }
